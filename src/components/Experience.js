    ...
    <div className="my-24 md:my-28  sm:my-28 xs:my-28 ">
      ...
      <div ref={ref} className="w-[75%] mx-auto relative lg:w-[90%] md:w-full">
        ...
        <ul className="w-full flex flex-col items-start justify-between ml-4">
          <Details
            position="Software Developer [Cynclair]"
            company=" RV Connex"
            time="June 2024 - Present"
            companyLink="https://www.rvconnex.com/en/home"
            address="Pathum Thani, Thailand"
            description="As a Software Developer at RV Connex [Cynclair], I design and implement innovative software solutions tailored to client requirements. Working collaboratively with cross-functional teams through, I leverage my expertise in Next.js, TypeScript, GraphQL, CI/CD, AWS, API integration, and programming to deliver high-quality applications. I am committed to building intuitive user interfaces and optimizing backend processes to enhance overall system performance."
          />
          <Details
            position="Teaching Assistant"
            company=" Sirindhorn International Institute of Technology (SIIT), Thammasat University"
            time="[Aug 2023 - Dec 2023] [Jan 2024 - May 2024]"
