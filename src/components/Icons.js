...
export const XDIcon = (props) => (
  <svg
    ...
    {...props}
  >
    <style>{".st1{fill:#ff2bc2}"}</style>
    <path
      d="M10 10h220v214H10z"
      style={{
        fill: "#2e001e",
      }}
    />
    <path d="M0 0v234h240V0H0zm10 10h220v214H10V10z" className="st1" />
    <path
      d="M174.3 98.3c-1.5-.7-3.4-1-5.8-1-12.6 0-21 9.7-21 25.8 0 18.4 8.6 25.8 19.8 25.8 2.4 0 5-.3 6.9-1.1V98.3h.1zm-44.8 25.6c0-23.3 15-41.5 39.6-41.5 2.1 0 3.2 0 5.2.2v-26c0-.6.5-1 1-1h16.1c.8 0 1 .3 1 .8v91.4c0 2.7 0 6.1.5 9.8 0 .7 0 .8-.6 1.1-8.4 4-17.2 5.8-25.6 5.8-21.7 0-37.2-13.4-37.2-40.6zm-34.1-16.2 28 54.3c.5.8.2 1.6-.6 1.6h-17.4c-1.1 0-1.6-.3-2.1-1.3-6.4-13.2-12.9-26.9-19.6-41.1h-.2c-6 13.4-12.6 28-19 41.2-.5.8-1 1.1-1.8 1.1H46.1c-1 0-1.1-.8-.6-1.4l27.4-52.7L46.4 57c-.6-.8 0-1.5.7-1.5h17.2c1 0 1.5.2 1.8 1.1C72.4 69.9 78.8 83 84.8 96.4h.2c5.8-13.2 12.2-26.5 18.3-39.6.5-.8.8-1.3 1.8-1.3h16.1c.8 0 1.1.6.6 1.5l-26.4 50.7z"
      className="st1"
    />
  </svg>
);
...
export const DataAnaIcon = (props) => (
  ...
  >
    ...
    />
    <path
      d="M74.8 434c46 45.6 109.2 74 179.2 74s133.2-28.4 179.2-74H74.8z"
      style={{
        fill: "#84dbff",
      }}
    />
    <path
      d="M214.8 368.8h78.4v41.6h-78.4z"
      style={{
        fill: "#fff",
      }}
    />
    <path
      d="M214.8 368.8h78.4v9.2h-78.4zM326.8 434H181.2c0-13.2 10.8-24 24-24h97.6c13.2.4 24 10.8 24 24z"
      style={{
        fill: "#e6e9ee",
      }}
    />
    <path
      d="M410 368.8H98c-9.6 0-17.6-8-17.6-17.6V136.8c0-9.6 8-17.6 17.6-17.6h312c9.6 0 17.6 8 17.6 17.6v214.8c0 9.2-8 17.2-17.6 17.2z"
      style={{
        fill: "#324a5e",
      }}
    />
    <path
      d="M80.4 334v17.6c0 9.6 7.6 17.2 17.2 17.2H410c9.6 0 17.2-7.6 17.2-17.2V334H80.4zM93.6 131.6h321.2v187.6H93.6z"
      style={{
        fill: "#fff",
      }}
    />
    ...
    />
    <path
      d="M127.2 184.8H166v110.8h-38.8z"
      style={{
        fill: "#acb3ba",
      }}
    />
    <path
      d="M180.8 232.8h38.8V296h-38.8z"
      style={{
        fill: "#4cdbc4",
      }}
    />
    <path
      d="M234.4 203.2h38.8v92.4h-38.8z"
      style={{
        fill: "#ffd05b",
      }}
    />
    <path
      d="M288.4 152.8h38.8v142.8h-38.8z"
      style={{
        fill: "#84dbff",
      }}
    />
    <path
      d="M342 263.2h38.8v32.4H342z"
      style={{
        fill: "#ff7058",
      }}
    />
