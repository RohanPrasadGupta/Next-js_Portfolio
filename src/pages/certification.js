...
const CertiLine = ({title,date,img,link})=>{
    return(
            ...
            viewport={{once:true}}
            className='relative w-full p-4 py-4 mt-4 rounded-xl flex items-center justify-between bg-light text-dark first:mt-0 border border-solid border-dark border-r-4 border-b-4'>
...
const Certificate = ({img,date,title}) =>{
    return(
        ...
        <div className='item-center p-3 rounded-2xl shadow-2xl '>
            ...
            <h3 className='font-bold text-black pt-0 m-4 hover:underline'>{title} <span className='text-sm text-primary'>{date}</span></h3>
            </div>
        </div>
        </li>
    )
    ...
    <>
        ...
        <main className='flex w-full flex-col items-center justify-center'>
            <Layout className={'p-16'}>
                <AnimatedText text="Certification" className='mb-16'/>
                ...
                <h2 className='text-bold text-4xl w-full text-center mt-20 mb-16'>All Certificates..</h2>
