    ...
    return(
        <li className='my-8 first:mt-0 last:mb-0 w-[60%] mx-auto flex flex-col item-start justify-between'>
            ...
            transition={{duration:1 , type:'keyframes'}}>
                ...
                <span className='capitalize text-dark font-bold text-sm'>{time} | {organization}</span>
...
const Education = () => {
  ...
  return (
    ...
    <div className='my-[10px]  items-center'>
        <h2 className='font-bold text-8xl text-center w-full mb-20'>Education</h2>
        ...
        <motion.div 
            ...
            className='bg-dark origin-top w-[4px] h-full left-9 absolute top-1' />
                ...
                <ul>
                    <Details
                    title = "Master Degree in artificial intelligence and IoT" 
                    time = "[2022 - Current]"
        ...
        <AnimatedText text='A good education gives you the knowledge, and skills give you the confidence to succeed....' className='mt-40'/>
    </div>
    </Layout>
    </main>
    </>
