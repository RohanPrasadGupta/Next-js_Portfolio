          ...
          <div className="flex item-center justify-between w-full lg:flex-col">
            <div className="w-1/2 md:w-full">
              <Image
                src={profilepic}
                alt="ROHAN"
                className="w-full h-auto lg:hidden md:inline-block md:w-full border-solid border-2 border-dark/75 rounded-2xl  shadow-2xl border-b-4 border-r-4  "
                priority
            ...
            <div className="w-1/2 felx felx-col items-center self-center lg:w-full lg:text-center mx-4">
              ...
              <div className="flex content-between m-[25%]  self-start mt-2 lg:self-center ">
                ...
                <Link
                  ...
                  target={"_blank"}
                  className="ml-4 text-lg my-2 font-medium capitalize text-dark underline md:text-base"
                >
                  Contact
                </Link>
              </div>
